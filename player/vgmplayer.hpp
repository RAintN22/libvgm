...
protected:
	...
	void Cmd_MSM5205_Reg(void);				// command 42 - MSM5205 register write, vclk (8-bit), Data (8-bit)
	...
	void Cmd_BSMT2000_Reg(void);			// command C9 - BSMT2000 register write (8-bit) Register, (16-bit) Data
